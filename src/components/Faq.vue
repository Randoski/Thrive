    ...
    <div>
        <section class="bg-white">
            <div class="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
                <h2
                    class="mb-8 text-4xl tracking-tight font-extrabold text-gray-600"
                >
                ...
                >
                    <div>
                        <div class="mb-10">
                            <h3
                                class="flex items-center mb-4 text-lg font-bold text-gray-700"
                            >
                    ...
                    <div>
                        ...
                        <div class="mb-10">
                            ...
                            <p class="text-gray-500">
                                ...
                                <a
                                    href="#"
                                    class="font-medium underline text-yellow hover:no-underline"
                                    >free version</a
                                >
