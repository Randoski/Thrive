  ...
  <div class="container mx-auto">
    ...
    <div class="grid grid-cols-12 gap-5 mt-10">
      ...
      <div class="col-span-12 xl:col-span-3 lg:col-span-3 md:col-span-6 sm:col-span-6">
        <BaseCard noPadding class="overflow-hidden">
          <div class="p-5">
            ...
            <div class="mt-28">
              <p class="text-gray-500 text-5xl m-0 font-extrabold">5</p>
              <div class="text-gray-500 font-bold mt-2">Active Projects</div>
            </div>
          </div>
        </BaseCard>
      </div>
      ...
      <div class="col-span-12 xl:col-span-3 lg:col-span-3 md:col-span-6 sm:col-span-6">
        <BaseCard noPadding class="overflow-hidden">
          <div class="p-5">
            <i class="fas fa-trophy fa-fw fa-2x text-primary"></i>
            <div class="mt-28">
              <p class="text-gray-500 text-5xl m-0 font-extrabold">2</p>
              <div class="text-gray-500 font-bold mt-2">Completed Projects</div>
            </div>
          </div>
        </BaseCard>
      </div>
      ...
      <div class="col-span-12 xl:col-span-3 lg:col-span-3 md:col-span-6 sm:col-span-6">
        <BaseCard noPadding class="overflow-hidden">
          <div class="p-5">
            <i class="fas fa-calendar-alt fa-fw fa-2x text-info"></i>
            <div class="mt-28">
              <p class="text-gray-500 text-5xl m-0 font-extrabold">0</p>
              <div class="text-gray-500 font-bold mt-2">Upcoming Projects</div>
            </div>
          </div>
        </BaseCard>
      </div>
      ...
      <div class="col-span-12 xl:col-span-3 lg:col-span-3 md:col-span-6 sm:col-span-6">
        <BaseCard noPadding class="overflow-hidden">
          <div class="p-5">
            <i class="fas fa-hourglass-half fa-fw fa-2x text-danger"></i>
            <div class="mt-28">
              <p class="text-gray-500 text-5xl m-0 font-extrabold">0</p>
              <div class="text-gray-500 font-bold mt-2">Overdue Projects</div>
            </div>
          </div>
        </BaseCard>
      </div>
          ...
          >
              ...
              <form class="flex items-center">
                ...
                <div class="relative w-full">
                  ...
                  <input
                    type="text"
                    id="simple-search"
                    class="bg-orange-50 text-gray-700 text-sm rounded-md block w-full pl-10 p-2 focus:outline-none border-none"
                    placeholder="Search"
                    required=""
                  />
                </div>
            ...
            >
              <button
                ...
                class="flex items-center justify-center text-white bg-primary font-medium rounded-lg text-sm px-4 py-2 focus:outline-none"
              >
                Add product
              </button>
              ...
              <div class="flex items-center space-x-3 w-full md:w-auto">
                <button
                  ...
                  class="w-full md:w-auto flex items-center justify-center py-2 px-4 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-md border border-gray-200 hover:bg-gray-100"
                  type="button"
                >
                  <!-- Actions Icon -->
                  <svg
                ...
                >
                  ...
                  >
                    <li>
                      <!-- Mass Edit -->
                      <div class="block py-2 px-4 hover:bg-gray-100 cursor-pointer">
                        Mass Edit
                      </div>
                    </li>
                  </ul>
                  ...
                  <ul class="space-y-2 text-sm" aria-labelledby="filterDropdownButton">
                    ...
                    <li class="flex items-center">
                      <input
                        ...
                        type="checkbox"
                        value=""
                        class="w-4 h-4 bg-gray-100 border-gray-300 rounded text-primary focus-transparent"
                      />
        ...
        <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
          ...
          <dl>
            ...
            <dd class="mb-4 font-light text-gray-500 sm:mb-5 dark:text-gray-400">
              ...
              GDDR6 memory, 256GB SSD storage, Gigabit Ethernet, Magic Mouse 2, Magic
              Keyboard - US.
            </dd>
            <dt class="mb-2 font-semibold leading-none text-gray-900 dark:text-white">
              Category
